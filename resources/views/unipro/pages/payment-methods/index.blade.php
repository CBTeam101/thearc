    ...
    <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
      ...
      <div class="card">
        ...
        <div class="card-body mt-4">
          ...
          <form class="needs-validation" novalidate id="payment-method-form">
            <!-- Row start -->
            <div class="row gutters">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table id="payment-methods-table" class="table custom-table">
              <thead>
                <tr>
                  <th>Name</th>
...
@section('scripts')
@include('unipro.pages.payment-methods.index-scripts')
@endsection