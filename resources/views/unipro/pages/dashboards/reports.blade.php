              ...
              <table class="table products-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="media-box">
                        <img class="media-avatar" src="img/products/bag.jpeg" alt="Product Image">
                  ...
                  <tr>
                    <td>
                      <div class="media-box">
                        <img class="media-avatar" src="img/products/pencils.jpeg" alt="Product Image">
                        <div class="media-box-body text-truncate">
                          <a href="#">Pencils</a>
                          <p>#FLM0568</p>
                        </div>
                  ...
                  <tr>
                    <td>
                      <div class="media-box">
                        <img class="media-avatar" src="img/products/toy.jpeg" alt="Product Image">
                        <div class="media-box-body text-truncate">
                          <a href="#">Wooden Toy</a>
                          <p>#FLM0760</p>
                        </div>
      ...
      <div class="card-body pt-0">
        ...
        <div class="row gutters justify-content-center">
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
            <div class="monthly-earnings bg-success text-white">
              <p>Today Earnings</p>
              <h4>$2,059</h4>
            </div>
          </div>
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
            <div class="monthly-earnings bg-warning text-white">
              <p>Weekly Earnings</p>
              <h4>$4,275</h4>
            </div>
          </div>
          <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
            <div class="monthly-earnings bg-danger text-white">
