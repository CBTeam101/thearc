    ...
    <div class="row gutters">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        <div class="stats-tile">
          <div class="sale-icon light-blue">
            <i class="icon-shopping-bag1 text-white"></i>
          </div>
          <div class="sale-details">
            <h2 class="text-white">15M</h2>
            <p>Orders</p>
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        <div class="stats-tile">
          <div class="sale-icon lighter-blue">
            <i class="icon-package text-white"></i>
          </div>
          <div class="sale-details">
            <h2 class="text-white">32M</h2>
            <p>Revenue</p>
