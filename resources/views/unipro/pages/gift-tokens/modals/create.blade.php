<!-- Modal start -->
<div class="modal fade" id="gift-token-create-modal" aria-labelledby="user-create-modal" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="needs-validation was-validated" novalidate="" id="gift-token-create-form">
                ...
                <div class="card-body">
                  ...
                  <div class="row gutters">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <!-- Field wrapper start -->
                      <div class="field-wrapper">
                        <select class="select-single" name="create-gift-token-user-account" required data-live-search="true">
                          <!-- Select2 -->
                        </select>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <!-- Field wrapper start -->
                      <div class="field-wrapper">
                        <select name="create-gift-token-token-type" class="single-select" required>
                          <!-- Select 2 -->
                        </select>
                ...
                <div class="card-body">
                  ...
                  <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <!-- Field wrapper start -->
                      <div class="field-wrapper">
                        <textarea name="create-gift-token-description" cols="" rows="7" placeholder="Fill in the fields with details depending on the payment method."></textarea>
