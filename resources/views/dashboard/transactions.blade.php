        ...
        <table class="table display mb-4 dataTablesCard " id="example-5">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/11.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
              ...
              <td>
                <div class="text-black"> <span class="mr-2 oi-icon bgl-success">
            ...
            <tr>
              ...
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td>
                <div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/25.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
              ...
              <td>
                <div class="text-black"> <span class="mr-2 oi-icon bgl-danger">
            ...
            <tr>
              ...
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td>
                <div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/27.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
            ...
            <tr>
              ...
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td>
                <div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/23.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
            ...
            <tr>
              ...
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td>
                <div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/28.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
            ...
            <tr>
              ...
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td>
                <div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/29.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
            ...
            <tr>
              ...
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td>
                <div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/22.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
            ...
            <tr>
              ...
              <td><span class="text-black text-nowrap">#June 1, 2020, 08:22 AM</span></td>
              <td>
                <div class="d-flex align-items-center"> <img src="{{ asset('images/avatar/20.png') }}" alt="" class="rounded-circle mr-3" width="50">
                  <div>
